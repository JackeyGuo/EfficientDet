...
def get_args():
    ...
    parser.add_argument('--batch_size', type=int, default=5, help='The number of images per batch among all devices')
    ...
    date = 'd1-0526'
    det_path = r'/home/data/weights/efficientdet/clas1/efficientdet-d2-1.pth'
...
def train(opt):
    ...
    if opt.image_size != None:
        image_size = opt.image_size
    else:
        input_sizes = [512, 640, 768, 896, 1024, 1280, 1280, 1536]
        image_size = input_sizes[opt.compound_coef]
