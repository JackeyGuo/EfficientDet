...
from thirdpart.evaluate.cocoeval import COCOeval
from thirdpart.evaluate.coco import COCO
...
ap.add_argument('-p', '--project', type=str, default='wheat', help='project file that contains parameters')
ap.add_argument('-c', '--compound_coef', type=int, default=1, help='coefficients of efficientdet')
ap.add_argument('-w', '--weights', type=str, default='outputs/d1-0524/d1_0.1642_0.0279_0.1362_147.pth',
...
if __name__ == '__main__':
    ...
    VAL_GT = f'/home/data/detection/{params["project_name"]}/annotations/instances_{SET_NAME}.json'
    VAL_IMGS = f'/home/data/detection/{params["project_name"]}/images/{SET_NAME}/'
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
